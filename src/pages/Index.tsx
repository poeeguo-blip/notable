  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div className="md:hidden flex flex-col h-full overflow-hidden">
        {selectedNote ? (
          <>
            <div className="flex items-center gap-3 px-3 py-3 border-b bg-background h-14 flex-shrink-0">
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8"
          ...
          <>
            <div className="flex items-center justify-between gap-2 px-4 py-3 border-b bg-background h-14 flex-shrink-0">
